...
function Register() {
    ...
    return (
        <>
            <form className="container col-6 border border-4 rounded-3 d-grid gap-1" style={{ marginTop: "10vh" }} onSubmit={e => submited(e)}>
                ...
                <button type="submit" disabled={error.email || error.password || error.username || error.name || error.confirmpassword} className="btn btn-info col-10 offset-1 btn-gradient text-dark btn-opacity-50">Submit</button>
                <br></br>
